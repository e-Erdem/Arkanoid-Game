...
public class gamePlay3 extends gamePlay{
	...
	public void drawatStart() {
		...
		int n=0;
		t.start();
		myBackgroundIcon = new ImageIcon(getClass().getResource("ocean.jpg"));
		backgroundimage = myBackgroundIcon.getImage();
		brick = new ImageIcon(getClass().getResource("11329lw3.png"));
